<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" ValidateRequest="false"  CodeFile="Edit.aspx.cs" Inherits="purchaseorder_Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    display: block; font-size: 16px; padding-bottom: 10px;">编辑采购订单信息：</h4>
            <p></p>
            <p>
...
<tr>
<td  style=" text-align:right; width:20%;"><font style='color:red'>*&nbsp;</font>采购时间:</td>
<td class="tbright"><div style="display:inline;float:left;">
<asp:TextBox ID="txt_atime" runat="server" width="200"></asp:TextBox>
    <asp:RequiredFieldValidator ID="rfvatime" runat="server" 
        ...
        ErrorMessage="采购日期不能为空！"></asp:RequiredFieldValidator>
    <asp:RangeValidator ID="rvatime" runat="server" 
        ControlToValidate="txt_atime" Display="Dynamic" ErrorMessage="采购日期格式不正确！" 
