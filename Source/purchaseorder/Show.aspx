<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" ValidateRequest="false"  CodeFile="Show.aspx.cs" Inherits="purchaseorder_Show" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    display: block; font-size: 16px; padding-bottom: 10px;">查看采购订单信息：</h4>
            <p></p>
            <p>
