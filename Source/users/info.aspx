<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" ValidateRequest="false"  CodeFile="info.aspx.cs" Inherits="users_info" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    display: block; font-size: 16px; padding-bottom: 10px;">修改个人信息：</h4>
            <p></p>
            <p>
...
<asp:TextBox ID="txt_userid" runat="server" width="200" Enabled="False"></asp:TextBox></div>
 </td></tr>
...
<td class="tbright"><div style="display:inline;float:left;">
<asp:TextBox ID="txt_userstate" runat="server" width="200" ReadOnly="true" ></asp:TextBox>
