<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" ValidateRequest="false"  CodeFile="Add.aspx.cs" Inherits="users_Add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    display: block; font-size: 16px; padding-bottom: 10px;">添加员工信息：</h4>
            <p></p>
            <p>
...
<td class="tbright"><div style="display:inline;float:left;">
    ...
    <asp:DropDownList  ID="txt_userstate" runat="server" width="200">
        <asp:ListItem Text="销售员" Value="销售员"></asp:ListItem>
        <asp:ListItem Text="采购员" Value="采购员"></asp:ListItem>
        <asp:ListItem Text="仓管员" Value="仓管员"></asp:ListItem>
    </asp:DropDownList>
