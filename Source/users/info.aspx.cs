...
public partial class users_info : System.Web.UI.Page
{
    ...
    protected void chushi()
    {
        ...
        strSql.Append(@"select * from users where userid='" + Session["id"].ToString() + "'");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        SqlParameter[] parameters = new SqlParameter[] {
              ...
              parameters[1].Value = txt_username.Text;
              parameters[2].Value =rtsex.SelectedValue;
              parameters[3].Value = txt_tel.Text;
              parameters[4].Value = txt_address.Text;
              parameters[5].Value = txt_userstate.Text;
              parameters[6].Value = txt_remark.Text;
