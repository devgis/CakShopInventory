<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" ValidateRequest="false"  CodeFile="Show.aspx.cs" Inherits="suppliers_Show" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    display: block; font-size: 16px; padding-bottom: 10px;">查看供应商信息：</h4>
            <p></p>
            <p>
 ...
 <tr>
	<td height="25" width="20%" align="right">供应商名称：</td>
	<td height="25" width="*" align="left" style="text-align:left"><asp:Label ID="lblsname" runat="server" Text=""></asp:Label></td>
	</tr>
