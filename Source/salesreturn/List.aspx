<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" ValidateRequest="false"  CodeFile="List.aspx.cs" Inherits="salesreturn_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    display: block; font-size: 16px; padding-bottom: 10px;">管理销售退库信息：</h4>
            <p></p>
            <p>
    ...
    <tr>
        ...
        <Columns>       
            ...
            <ItemTemplate>
            <%# StringHelper.SubStringHtml( Eval("reason").ToString(),20) %>
            </ItemTemplate>
            </asp:TemplateField>
