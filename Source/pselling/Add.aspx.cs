...
public partial class pselling_Add : System.Web.UI.Page
{
    ...
    {   
       //设置Sql
         ...
         strSql.Append(@"insert into Pselling ( pid,nnum,price,remark,auser,atime ) ");
        strSql.Append(@" values (@pid,@nnum,@price,@remark,@auser,@atime)");
        ...
        parameters[2].Value =decimal.Parse (txt_price.Text);
        parameters[3].Value =txt_remark.Text;
        parameters[4].Value =txt_auser.Text;
        parameters[5].Value = DateTime.Parse(DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
