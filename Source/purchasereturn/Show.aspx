<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" ValidateRequest="false"  CodeFile="Show.aspx.cs" Inherits="purchasereturn_Show" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    display: block; font-size: 16px; padding-bottom: 10px;">查看采购退库信息：</h4>
            <p></p>
            <p>
 ...
 <tr>
	...
	<td height="25" width="*" align="left" style="text-align:left"><asp:Label ID="lblreasons" runat="server" Text=""></asp:Label></td>
	</tr>
 <tr>
