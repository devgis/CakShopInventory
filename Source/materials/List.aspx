<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" ValidateRequest="false"  CodeFile="List.aspx.cs" Inherits="materials_List" %>
...
<strong> 用途:</strong><asp:TextBox ID="txt_remark" runat="server" width="150"></asp:TextBox>
    ...
    <tr>
        ...
        <Columns>       
            ...
            <a href="Edit.aspx?id=<%#Eval("mid") %>">编辑</a>
                    <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False"   CommandName='<%#Eval("mid") %>' OnClick="lnk_Click" Text="删除" OnClientClick='return confirm("您确定要删除此信息么？");'></asp:LinkButton>
            </ItemTemplate>
